...
// ═══════════════════════════════════════════════════════════════
// DFS: verifica se 'target' é alcançável a partir de 'start' na MST
// ═══════════════════════════════════════════════════════════════
    ...
    uint8_t   num_active)
{
    ...
    for (int i = 0; i < num_active; i++) {
        ...
        if (mst[my_idx][i] != 1) continue;  /* só vizinhos directos na MST */
        ...
        /* quem é alcançável VIA este vizinho? */
...
void routing_manager_recompute(routing_manager_t *rm,
    ...
    /* 2. Preenche routing_table[] e escreve cada rota no kernel */
    ...
    for (int i = 0; i < num_active; i++) {
        ...
        /* preenche entrada na routing table user-space */
...
// ═══════════════════════════════════════════════════════════════
// LOOKUP (chamado pelo TX para obter next_hop em runtime)
// ═══════════════════════════════════════════════════════════════
