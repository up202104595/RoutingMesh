...
However, the Layer~2 approach presented several limitations in practice:
the manipulation of ARP tables caused instability and runtime failures in
certain topology transitions, standard diagnostic tools such as traceroute
and ping did not reflect the actual forwarding path, and integration with
operating system networking features was limited. These shortcomings motivated
the investigation of an alternative architecture that retains the MST routing
strategy proven effective by Morais while addressing the observed robustness
and observability deficiencies.
