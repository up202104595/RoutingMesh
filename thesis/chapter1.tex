...
The objective of the present work was therefore to build a complete,
functional routing system from the ground up, retaining the MST strategy
validated by Morais while resolving the observed stability issues and
addressing the observability limitations through a Layer~3 architecture.
