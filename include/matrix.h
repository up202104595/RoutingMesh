...
#define MAX_AGE 5.0
#define MATRIX 1
#define MSG_DATA 2   /* ← adicionar esta linha */

// ═══════════════════════════════════════════════════════════════
// MODOS DE LINK QUALITY INICIAL
// ═══════════════════════════════════════════════════════════════
#define LINK_QUALITY_MODE_CRITICAL  1   // Novo nó começa a 20 (desconfiança)
#define LINK_QUALITY_MODE_TEST      2   // Novo nó começa a 100 (confiança total)
#define LINK_QUALITY_MODE_PROD      3   // Novo nó começa a 50 (moderado)

#ifndef LINK_QUALITY_MODE
#define LINK_QUALITY_MODE LINK_QUALITY_MODE_TEST  // Default: TEST
#endif
