...
\begin{itemize}
    ...
    Morais~\cite{morais2024synchronization} from published documentation, and
    its side-by-side re-run on the same three-node testbed, enabling a direct
    comparison of the two architectures under identical conditions;
