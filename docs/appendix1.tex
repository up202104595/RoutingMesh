...
The active nodes of the testbed, with their role, hardware model, physical and
mesh addresses, and MAC addresses, are listed in Table~\ref{tab:netconfig} of
...
\begin{lstlisting}[language=bash,caption={Checking whether the wireless interface supports ad hoc mode},label=lst:app-iwinfo]
iw dev wlan0 info
\end{lstlisting}
...
hoc mode directly by the network configuration of the system. Code
